...
Revision ID: 408399798b12
Revises: f04722eb4805
Create Date: 2024-03-02 20:08:03.770840
...
def upgrade() -> None:
    ...
    op.execute("alter type paymentstatusenum rename value 'PAID' to 'SUCCEEDED'")
